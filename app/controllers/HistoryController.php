    ...
    public function indexAction()
    {
        $versions = [
            ...
            [
                ...
                'changes' =>
                    'Вторая версия отчетов - теперь есть общий отчет и детальный по каждому сотруднику!Отладка множества функции - провели тотальную полировку!Внедрены подпункты для задач!Поправлена логика некоторых достижений!Мобильная адаптация всех страниц',
