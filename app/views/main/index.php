    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4 text-center">
                ...
                <p class="mt-3">В системе управления Lusy.io нет ограничений на количество сотрудников - пригласите
                    всех!</p>
            </div>
            <div class="col-sm-4 text-center">
                <div class="blockExcellence position-relative">
                ...
                <p class="mt-3">Разгрузите свою голову, e-mail и мессенджеры - напишите название задачи, назначьте
                    исполнителя и срок.</p>
            </div>
            <div class="col-sm-4 text-center">
                <div class="blockExcellence position-relative">
                ...
                <p class="mt-3">Ни одна ваша идея теперь не останется без реализации и контроля. Теперь вы - супер<i>бизнес</i>мен.
                </p>
            </div>
            <hr class="w-100 mt-4">
