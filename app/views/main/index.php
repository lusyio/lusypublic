        ...
        <div class="row first-block">
            <div class="col-sm-8 text-left">
                ...
                <div class="mt-5">
                    ...
                    <form onsubmit="ym(53097463, 'reachGoal', 'reg'); return true;" id="regForm1" method="post"
...
<div class="visible-sm">
    <div id="swiperAchieve" class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
...
<!-- Initialize Swiper -->
<script>
    var swiper = new Swiper('#swiperAchieve', {
        effect: 'coverflow',
        grabCursor: true,
        centeredSlides: true,
        slidesPerView: 'auto',
