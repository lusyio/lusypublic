...
<div class="tab-content" id="tabLusyContent">
    ...
    <div class="tab-pane container" id="ways" role="tabpanel" aria-labelledby="waysTab">
        ...
        <p>Вы можете рассказывать о Lusy.io своим друзьям, пересылая им сгенерированные ссылки для регистрации или
            бесплатные промокоды на Premium-функционал. Благодря этим вещам, мы сможем отследить от кого пришел человек
        ...
        <p>
            Еще вариант - на Вашем корпоративом сайте написать обзор системы и кратко описать, как Вы используете ее на
            практике. Люди обожают живые истории, поделитесь внутренним миром своей компании и заодно можете нам
