        ...
        <div class="col-12 col-lg-9 toc-content">
            <div>
                ...
                <div class="m-auto pt-3 pb-3">
                    <img src="/public/images/vypolnennye-dostizheniya.jpg" alt="vypolnennye-dostizheniya">
                </div>
                ...
                <h3 id="onceAchievements">Разовые</h3>
                <p>Достижения, которые можно получить всего лишь один раз, особые достижения на общую тематику.</p>
                <div class="m-auto pt-3 pb-3">
                    <img src="/public/images/razovye-dostizheniya.jpg" alt="razovye-dostizheniya">
                </div>
            </div>
        </div>
    </div>
